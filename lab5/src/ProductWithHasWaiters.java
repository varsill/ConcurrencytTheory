...
public class ProductWithHasWaiters implements Product{
    ...
    public ProductWithHasWaiters(int x)
    {
        MAX_SIZE = x;
    ...
    public void produce(int howMany)
    {
        ...
        try{
            ...
            while(howManyFree<howMany)
            {
                ...
                if(PIERWSZYPROD_counter>1)printCounters();
    ...
    public void consume(int howMany)
    {
        ...
        try{
            ...
            while(howManyTaken<howMany)
            {
                ...
                if(PIERWSZYKONS_counter>1)printCounters();
            }
